...
export const dialogueData = {
  pc: `This is my PC. I work mostly in Python these days.
    ...
    Here is my <a href="https://github.com/VAIBHAV13S" target="_blank">Github</a>!`,
    "Unknown": `I don't know what this is. Maybe we should tpgether be able to solve this mystery!`,
  "sofa-table": `That's my sofa. I like to relax here and watch YouTube and Movies.`,
  ...
  resume: `This is my desk and on it is my resume. <a href="https://github.com/VAIBHAV13S/Resume/blob/main/Resume.pdf" target="_blank">Check it out?</a>`,
  projects: `Info about this PlayFolio : It's made with the Kaboom.js library which is a library for making games in JavaScript.
  ...
  exit: `If you want to exit PlayFolio, just close the tab.`,
};